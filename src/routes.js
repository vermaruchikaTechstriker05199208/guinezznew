...
const AllSuggestion = React.lazy(() => import('./views/theme/suggestions/Allsuggestion'));
const ViewSuggestion = React.lazy(() => import('./views/theme/suggestions/Viewsuggestion'));
const routes = [
  ...
  { path: '/allsuggestions', name: 'Suggestions', component:AllSuggestion },
  { path: '/viewsuggestion/:clientId', name: 'View Suggestion', component:ViewSuggestion },
  { path: '/loginew', name: 'Logout', component: Logout },
